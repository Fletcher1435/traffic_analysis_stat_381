...
injury_data <- injury_data %>%
  mutate(PEDESTRIAN_Injury.Status = recode(PEDESTRIAN_Injury.Status,
                                           "Fatal Injury (K)" = "Severe/Fatal Injury",
                                           "Suspected Serious Injury (A)" = "Severe/Fatal Injury",
                                           "No Apparent Injury (O)" = "No/Minor Injury",
                                           "Possible Injury (C)" = "No/Minor Injury",
                                           "Suspected Minor Injury (B)" = "No/Minor Injury"))
